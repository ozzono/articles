...
Sendo assim, os usuários de Android ainda têm a opção de fazer a instalação de um app por fora da loja; o chamado _sideload_. Essa abordagem tem o enorme risco em razão do aplicativo escolhido ser difícil de auditar, podendo conter falhas de segurança significativas e ser de difícil rastreamento.
